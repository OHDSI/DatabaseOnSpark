...
<table class="table">
  ...
  <tr>
    ...
    <br/>
      This document describes how to create a complete OHDSI on Databricks implementation. 
      This can be used to connect an existing CDM instance (e.g. from your elt process). 
      Methods to create a test database are also included. 
